        ...
        <div className="titles glass">
          <div className="title_left">
            ...
            <div className="font-size-controls">
              <button className="glass" onClick={decreaseFontSize}>A–</button>
              <button className="glass" onClick={increaseFontSize}>A+</button>
              <button className="filter-toggle glass" onClick={() => setFilterOpen(true)}>
